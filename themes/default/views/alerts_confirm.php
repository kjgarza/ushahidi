		...
		<div class="big-block">
			...
			<?php endif; ?>
				...
				?>
					<div class="alert_confirm">
						<div class="label">
							<u><?php echo Kohana::lang('alerts.mobile_code'); ?>
							</u>
						</div>
						<?php
			...
			?>
				...
				?>
					<div class="alert_confirm">
						<div class="label">
							<u><?php echo Kohana::lang('alerts.email_code'); ?>
							</u>
						</div>
						<?php
						print form::open('/alerts/verify');
			...
			<div class="green-box">
				<div class="alert_response">
					<a href="<?php echo url::site().'alerts'?>"><?php echo Kohana::lang('alerts.create_more_alerts'); ?>
					</a>
				</div>
			</div>
			<!-- / Return -->
