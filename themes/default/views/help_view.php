			...
			<div class="incident-name">
				...
				<ul>
					...
					<li><strong>WEBSITE</strong>
						<p>
						<?php echo $organization_website; ?>
						</p></li>
					<li><strong>Phone</strong>
						<p>
						<?php echo $organization_phone1; ?>
						</p></li>
					<li><strong>Phone</strong>
						<p>
						<?php echo $organization_phone2; ?>
						</p></li>
				...
				<br /> <br /> <input class="btn_gray" type="button" value="Back"
					onclick="location.href='<?php echo url::site() . 'help/'; ?>';" />
			</div>
