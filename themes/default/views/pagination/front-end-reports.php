...
<?php if ($i == $current_page): ?>
	...
	<?php else: ?>
	<li><span><a href="<?php echo str_replace('{page}', $i, $url) ?>"><?php echo $i ?>
		</a> </span></li>
		<?php endif ?>
		<?php endfor ?>
	...
	<li><span><a
			href="<?php echo str_replace('{page}', $total_pages, $url) ?>"><?php echo $total_pages ?>
		</a> </span></li>

		<?php elseif ($current_page < 100): ?>
	<li><span><a href="<?php echo str_replace('{page}', 1, $url) ?>">1</a>
	</span></li>
	<li>&hellip;</li>
