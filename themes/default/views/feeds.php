<div id="content">
	<div class="content-bg">
		...
		<div class="big-block">
			<h1>
			<?php echo Kohana::lang('ui_admin.feeds').': '.$pagination_stats; ?>
			</h1>
			<div class="report_rowtitle">
				<div class="report_col2">
					<strong><?php echo Kohana::lang('feeds.title');?>
					</strong>
				</div>
				<div class="report_col3">
					<strong><?php echo Kohana::lang('feeds.date');?>
					</strong>
				</div>
				<div class="report_col4">
					<strong><?php echo Kohana::lang('feeds.source');?>
					</strong>
				</div>
			</div>
			<?php
