...
<link
	href="<?php echo url::base() ?>media/css/jquery-ui-themeroller.css"
	rel="stylesheet" type="text/css" />
<link href="<?php echo url::base() ?>media/css/login.css"
	rel="stylesheet" type="text/css" />
</head>
		...
		<div id="ushahidi_login" class="ui-corner-all">
			<table width="100%" border="0" cellspacing="3" cellpadding="4"
				...
				<form method="POST" name="frm_login"
					...
					<tr>
						<td><input type="checkbox" id="remember" name="remember" value="1"
							checked="checked" /> <?php echo Kohana::lang('ui_main.password_save');?>
						</td>
					</tr>
					<tr>
						<td><input type="submit" id="submit" name="submit" value="Log In"
							class="login_btn" /></td>
					</tr>
					<tr>
						<td><a href="<?php echo url::site()?>login/resetpassword"> <?php echo Kohana::lang('ui_main.forgot_password');?>
						</a></td>
					</tr>
				</form>
			</table>
