	...
	<div class="showcase">
		...
		<div class="checkins">
			...
			<div id="downloads">
				...
				<div>
					You can submit your own checkins to this deployment by downloading
					the application pointing it at
					<?php echo url::site(); ?>
					.
				</div>
				<a href="http://download.ushahidi.com/dl/ios" class="dl-btn dl-ios">iOS</a>
				<a href="http://download.ushahidi.com/dl/android"
					class="dl-btn dl-android">Android</a>
				</p>
			</div>
