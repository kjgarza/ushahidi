...
<div id="ushahidi_install_container" class="advanced">
	<div class="bg">
		...
		<div class="table-holder">
			...
			<p>
				So, I'm going to upgrade your database from version
				<?php print $db_version; ?>
				to the newest database.
			</p>
			<p>Click on the "Upgrade" button and just chilax as I perform the
				magic.</p>
			<p>Oh, also if you want me to backup your database, just thick the
				check button below and I will do that for you in a breeze.</p>
			...
			<p>
				<input type="submit" id="upgrade" name="submit"
					value="<?php echo Kohana::lang('upgrade.upgrade_db_btn_text');?>"
					class="login_btn" />
			</p>
