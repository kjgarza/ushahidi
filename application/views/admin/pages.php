...
<div class="bg">
	...
	<div class="green-box">
		<h3>
		<?php echo Kohana::lang('ui_main.page_has_been');?>
	...
	<?php print form::open(NULL,array('id' => 'pageListing',
		...
		<input type="hidden" name="action" id="action" value=""> <input
			type="hidden" name="page_id" id="page_id_action" value="">
					...
					<tr>
						...
						<td class="col-2">
							<div class="post">
								...
								<p>
								<?php echo $page_description_short; ?>
								</p>
							</div>
						</td>
	...
	'<?php echo(base64_encode($page_description)); ?>')"><?php echo Kohana::lang('ui_main.edit');?>
								</a></li>
								<li class="none-separator"><a class="status_yes"
									href="javascript:pageAction('v','SHOW/HIDE','<?php echo(rawurlencode($page_id)); ?>')"><?php if ($page_active) { echo Kohana::lang('ui_main.visible'); }else{ echo Kohana::lang('ui_main.hidden'); }?>
								</a></li>
								<li><a
									href="javascript:pageAction('d','DELETE','<?php echo(rawurlencode($page_id)); ?>')"
	...
	<div class="tabs">
		...
		<?php print form::open(NULL,array('enctype' => 'multipart/form-data', 'id' => 'pageMain',
			...
			<input type="hidden" id="page_id" name="page_id"
				value="<?php echo $form['page_id']; ?>" /> <input type="hidden"
