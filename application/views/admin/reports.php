...
<div
	...
	<div class="tabs">
		...
		<ul class="tabset">
			<li><a href="?status=0"
			<?php if ($status != 'a' AND $status !='v') echo "class=\"active\""; ?>><?php echo Kohana::lang('ui_main.show_all');?>
			</a></li>
			<li><a href="?status=a"
		...
		<div class="tab">
			<ul>
				<li><a href="#"
					onclick="reportAction('a','<?php echo strtoupper(Kohana::lang('ui_main.approve')); ?>', '');">
					<?php echo Kohana::lang('ui_main.approve');?> </a>
				</li>
				<li><a href="#"
					onclick="reportAction('u','<?php echo strtoupper(Kohana::lang('ui_main.disapprove')); ?>', '');">
					<?php echo Kohana::lang('ui_main.disapprove');?> </a>
				</li>
				<li><a href="#"
					onclick="reportAction('v','<?php echo strtoupper(Kohana::lang('ui_admin.verify_unverify')); ?>', '');">
					<?php echo Kohana::lang('ui_admin.verify_unverify');?> </a>
				</li>
				<li><a href="#"
					onclick="reportAction('d','<?php echo strtoupper(Kohana::lang('ui_main.delete')); ?>', '');">
	...
	<input type="hidden" name="action" id="action" value=""> <input
		type="hidden" name="incident_id[]" id="incident_single" value="">
					...
					<td class="col-2">
						<div class="post">
							...
							<?php echo $incident_description; ?>
								... <a
									href="<?php echo url::base() . 'admin/reports/edit/' . $incident_id; ?>"
									class="more"><?php echo Kohana::lang('ui_main.more');?> </a>
							</p>
						</div>
						<ul class="info">
							<li class="none-separator"><?php echo Kohana::lang('ui_main.location');?>:
								<strong><?php echo $incident_location; ?> </strong>,<strong><?php if ($country_id !=0) { echo $countries[$country_id];} else { echo $countries[Kohana::config('settings.default_country')];}?>
							</strong></li>
					...
					<td class="col-4">
						<ul>
							...
							<?php if ($incident_approved) echo " class=\"status_yes\"" ?>
								onclick="reportAction('a','APPROVE', '<?php echo $incident_id; ?>');"><?php echo Kohana::lang('ui_main.approve');?>
							</a></li>
							<li><a href="#"
							...
							<li><a href="#" class="del"
								onclick="reportAction('d','DELETE', '<?php echo $incident_id; ?>');"><?php echo Kohana::lang('ui_main.delete');?>
							</a></li>
						</ul>
					</td>
				</tr>
