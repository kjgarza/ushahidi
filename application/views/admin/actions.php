...
<div
	...
	<div style="width: 100%; background-color: #FFD8D9; padding: 4px 0px;">
		<img
			src="<?php echo url::file_loc('img'); ?>media/img/experimental.png"
			alt="<?php echo Kohana::lang('ui_admin.experimental');?>"
			style="position: relative; float: left; padding-left: 250px; padding-right: 5px;" />This
		is an experimental feature. The Ushahidi and Crowdmap Teams cannot be
		<br />responsible for any mishaps, bugs or quirks that show up when
		using Actions.
	</div>
	<?php
	if ($form_error) {
	...
	<?php echo form::open('/admin/manage/actions/changestate',array('id' => 'actionListing', 'name' => 'actionListing')); ?>
		<input type="hidden" name="action_id" id="action_id" value=""> <input
			type="hidden" name="action_switch_to" id="action_switch_to" value="">
		<div class="table-holder">
			<table class="table">
				<thead>
					<tr>
						<th class="col-1" style="width: 125px;"><?php echo Kohana::lang('ui_admin.triggers'); ?>
						</th>
						<th class="col-2" style="width: 275px;"><?php echo Kohana::lang('ui_admin.qualifiers');?>
						</th>
						<th class="col-3" style="width: 125px;"><?php echo Kohana::lang('ui_admin.response');?>
						</th>
						<th class="col-4" style="width: 275px; text-align: left;"><?php echo Kohana::lang('ui_admin.actions');?>
						</th>
						<th class="col-5" style="width: 100px;"><?php echo Kohana::lang('ui_admin.state');?>
						</th>
					</tr>
				</thead>
				<tfoot>
				...
				foreach ($actions as $action)
				{
					...
					?>
					<tr>
						<td class="col-1" style="width: 125px; font-weight: bold;"><?php echo $trigger_options[$trigger]; ?>
						</td>
						<td class="col-2" style="width: 275px;"><?php echo $qualifier_string; ?>
						</td>
						<td class="col-3" style="width: 125px;"><?php echo $response_options[$response]; ?>
						</td>
						<td class="col-4" style="width: 275px; border-right: 0px;"><?php echo $response_string; ?>
						</td>
						<td class="col" style="width: 100px; border-left: 0px;"><?php if($active) {?>
						<?php echo Kohana::lang('ui_admin.currently_active'); ?><br /> <a
							href="javascript:actionsAction('0','DEACTIVATE',<?php echo rawurlencode($action_id);?>)"
							class="status_yes"><?php echo Kohana::lang('ui_main.deactivate'); ?>
						</a> <?php } else {?> <?php echo Kohana::lang('ui_admin.currently_inactive'); ?><br />
							<a
							href="javascript:actionsAction('1','ACTIVATE',<?php echo rawurlencode($action_id);?>)"
							class="status_no"><?php echo Kohana::lang('ui_main.activate'); ?>
						</a> <?php } ?>
						</td>
					</tr>
					<?php
	...
	<div class="tabs">
		...
		<a name="add"></a>
		<ul class="tabset">
			<li><a href="#" class="active"><?php echo Kohana::lang('ui_main.add_edit');?>
			</a></li>
		</ul>
		<!-- tab -->
		<div class="tab">
		<?php echo form::open(NULL,array('id' => 'actionsMain', 'name' => 'actionsMain')); ?>
			...
			<div id="divMap" style="width: 900px; height: 350px; border: 0px;">
				...
				<a href="#" class="btn_clear"
					style="float: right; margin-top: 350px; padding: 25px;"><?php echo strtoupper(Kohana::lang('ui_main.clear_map'));?>
				</a>
			</div>
			...
			<input type="hidden" id="action_id" name="action_id" value="" /> <input
				type="hidden" name="form_action" id="form_action" value="a" />

			<div style="float: right; padding: 25px 25px 0 0; text-align: right;">
			<?php echo Kohana::lang('ui_admin.server_time').' '.date("m/d/Y H:i:s",time()).' ('.$site_timezone.')'; ?>
				<br /> <a href="<?php echo url::base(); ?>admin/settings/site"><small><?php echo Kohana::lang('ui_admin.modify_timezone'); ?>
				</small> </a>
			</div>

			<h3>
			<?php echo Kohana::lang('ui_admin.trigger'); ?>
			</h3>
				...
				<div class="tab_form_item" id="action_form_trigger">
					<h4>
						<a href="#" class="tooltip"
							title="<?php echo Kohana::lang("tooltips.actions.trigger"); ?>"><?php echo Kohana::lang('ui_admin.trigger'); ?>:</a>
					</h4>
			...
			<div id="actions_qualifier_section" style="padding-top: 10px;">
				...
				<h3>
				<?php echo Kohana::lang('ui_admin.qualifiers'); ?>
				</h3>

				<div class="tab_form_item" id="trigger_first_qualifiers">
				<?php echo Kohana::lang('ui_admin.select_trigger_before_qualifiers'); ?>
				</div>
				...
				<div class="tab_form_item" id="action_form_user"
					...
					<h4>
						<a href="#" class="tooltip"
							title="<?php echo htmlspecialchars(Kohana::lang("tooltips.actions.user")); ?>"><?php echo Kohana::lang('ui_admin.user'); ?>:</a>
					</h4>
				...
				<div class="tab_form_item" id="action_form_location"
					...
					<h4>
						<a href="#" class="tooltip"
							title="<?php echo htmlspecialchars(Kohana::lang("tooltips.actions.location")); ?>"><?php echo Kohana::lang('ui_main.location'); ?>:</a>
					</h4>
					<?php echo form::radio('action_location', 'anywhere', TRUE, ' class="action_location"').' '.Kohana::lang('ui_admin.anywhere'); ?>
					<br />
				...
				<div class="tab_form_item" id="action_form_keyword"
					...
					<h4>
						<a href="#" class="tooltip"
							title="<?php echo htmlspecialchars(Kohana::lang("tooltips.actions.keywords")); ?>"><?php echo Kohana::lang('ui_admin.keywords'); ?>:</a>
					</h4>
				...
				<div class="tab_form_item" id="action_form_category"
					...
					<h4>
						<a href="#" class="tooltip"
							title="<?php echo htmlspecialchars(Kohana::lang("tooltips.actions.category")); ?>"><?php echo Kohana::lang('ui_main.category'); ?>:</a>
					</h4>
					<?php
				...
				<div class="tab_form_item" id="action_form_on_specific_count"
					...
					<h4>
						<a href="#" class="tooltip"
							title="<?php echo htmlspecialchars(Kohana::lang("tooltips.actions.on_specific_count")); ?>"><?php echo Kohana::lang('ui_admin.on_specific_count');?>:</a>
					</h4>
					<?php echo Kohana::lang('ui_admin.count').' '.form::input('action_on_specific_count','',' style="width:25px;"'); ?>
					<br />
					<?php echo form::radio('action_on_specific_count_collective', '0', TRUE).' '.Kohana::lang('ui_admin.triggering_user'); ?>
					<br />
					<?php echo form::radio('action_on_specific_count_collective', '1', FALSE).' '.Kohana::lang('ui_admin.entire_collective'); ?>

				</div>

				<div class="tab_form_item" id="action_form_days_of_the_week"
					style="margin-right: 75px;">
					<h4>
						<a href="#" class="tooltip"
							title="<?php echo htmlspecialchars(Kohana::lang("tooltips.actions.days_of_the_week")); ?>"><?php echo Kohana::lang('ui_admin.days_of_the_week');?>:</a>
					</h4>
					<?php
				...
				<div class="tab_form_item" id="action_form_between_times"
					style="margin-right: 75px;">
					<h4>
						<a href="#" class="tooltip"
							title="<?php echo htmlspecialchars(Kohana::lang("tooltips.actions.between_times")); ?>"><?php echo Kohana::lang('ui_admin.between_times');?>:</a>
					</h4>
					<?php
					$hours = range(0,24);
					...
					?>
					<?php echo form::dropdown('action_between_times_hour_1', $hours, 'standard'); ?>
					:
					<?php echo form::dropdown('action_between_times_minute_1', $minutes, 'standard'); ?>
					<center>
					<?php echo Kohana::lang('ui_main.and');?>
					</center>
					<?php echo form::dropdown('action_between_times_hour_2', $hours, 'standard'); ?>
					:
					<?php echo form::dropdown('action_between_times_minute_2', $minutes, 'standard'); ?>
				</div>

				<div class="tab_form_item" id="action_form_specific_days"
					style="margin-right: 75px;">
					<h4>
						<a href="#" class="tooltip"
							title="<?php echo htmlspecialchars(Kohana::lang("tooltips.actions.specific_days")); ?>"><?php echo Kohana::lang('ui_admin.specific_days');?>:</a>
					</h4>
					<div id="action_specific_days_calendar"
						class="action_specific_days_calendar"
						name="action_specific_days_calendar"></div>
					<input type="hidden" name="action_specific_days"
						id="action_specific_days" value="" />
				</div>
			...
			<div id="actions_response_section" style="padding-top: 10px;">
				...
				<h3>
				<?php echo Kohana::lang('ui_admin.response'); ?>
				</h3>

				<div class="tab_form_item" id="trigger_first_response">
				<?php echo Kohana::lang('ui_admin.select_trigger_before_response'); ?>
				</div>
				...
				<div class="tab_form_item" id="action_form_response"
					...
					<h4>
						<a href="#" class="tooltip"
							title="<?php echo htmlspecialchars(Kohana::lang("tooltips.actions.response")); ?>"><?php echo Kohana::lang('ui_admin.response'); ?>:</a>
					</h4>
					<?php
				...
				<div class="tab_form_item" id="action_form_email_send_address"
					...
					<h4>
						<a href="#" class="tooltip"
							title="<?php echo htmlspecialchars(Kohana::lang("tooltips.actions.send_to")); ?>"><?php echo Kohana::lang('ui_admin.send_to');?>:</a>
					</h4>
					<?php echo form::radio('action_email_send_address', '0', TRUE).' '.Kohana::lang('ui_admin.triggering_user'); ?>
					<br />
				...
				<div class="tab_form_item" id="action_form_email_subject"
					...
					<h4>
						<a href="#" class="tooltip"
							title="<?php echo htmlspecialchars(Kohana::lang("tooltips.actions.email_subject")); ?>"><?php echo Kohana::lang('ui_admin.subject');?>:</a>
					</h4>
				...
				<div class="tab_form_item" id="action_form_email_body"
					...
					<h4>
						<a href="#" class="tooltip"
							title="<?php echo htmlspecialchars(Kohana::lang("tooltips.actions.email_body")); ?>"><?php echo Kohana::lang('ui_admin.body');?>:</a>
					</h4>
				...
				<div class="tab_form_item" id="action_form_add_category"
					...
					<h4>
						<a href="#" class="tooltip"
							title="<?php echo htmlspecialchars(Kohana::lang("tooltips.actions.add_to_category")); ?>"><?php echo Kohana::lang('ui_admin.add_to_category'); ?>:</a>
					</h4>
					<?php
					// categories, selected_categories, form field name, number of columns
				...
				<div class="tab_form_item" id="action_form_verify"
					...
					<h4>
						<a href="#" class="tooltip"
							title="<?php echo htmlspecialchars(Kohana::lang("tooltips.actions.verify")); ?>"><?php echo Kohana::lang('ui_admin.mark_as');?>:</a>
					</h4>
					<?php echo form::radio('action_verify', '0', TRUE).' '.Kohana::lang('ui_main.unverified'); ?>
					<br />
				...
				<div class="tab_form_item" id="action_form_badge"
					...
					<h4>
						<a href="#" class="tooltip"
							title="<?php echo htmlspecialchars(Kohana::lang("tooltips.actions.assign_badge")); ?>"><?php echo Kohana::lang('ui_admin.assign_badge'); ?>:</a>
					</h4>
					<?php
			...
			<div class="tab_form_item">
				&nbsp;<br /> <input type="image"
					src="<?php echo url::file_loc('img'); ?>media/img/admin/btn-save.gif"
					class="save-rep-btn" />
			</div>
			<?php echo form::close(); ?>
		</div>
