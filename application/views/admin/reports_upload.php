...
<div class="bg">
	...
	?>
		...
		<div class="upload_container">
			<p>
			<?php echo Kohana::lang('ui_main.upload_reports_detail_1');?>
				.
			</p>
			<h3>
			<?php echo Kohana::lang('ui_main.please_note');?>
			</h3>
			<ul>
			...
			<p>
			<?php echo Kohana::lang('ui_main.upload_reports_detail_6');?>
				<br />
				<?php echo Kohana::lang('ui_main.upload_reports_detail_7');?>
				<br />
			...
			<p>
				<b><?php echo Kohana::lang('ui_main.upload_file');?> </b>
				<?php echo form::upload(array('name' => 'csvfile'), 'path/to/local/file'); ?>
			</p>
			<button type="submit">
			<?php echo Kohana::lang('ui_main.upload');?>
			</button>
