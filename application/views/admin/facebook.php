...
<div class="bg">
	...
	?>
		<div class="head">
			<h3>
			<?php echo Kohana::lang('settings.facebook.title');?>
			</h3>
			<input type="image"
		...
		<div class="sms_holder">
			<div class="row" style="margin-top: 20px;">
				<h4>
				<?php echo Kohana::lang('settings.facebook.description');?>
					:<BR /> <a href="http://www.facebook.com/developers/"
						target="_blank">http://www.facebook.com/developers/</a>
				</h4>
			</div>
			<div class="row">
				<h4>
				<?php echo Kohana::lang('settings.facebook.app_id');?>
					:
				</h4>
			...
			<div class="row">
				<h4>
				<?php echo Kohana::lang('settings.facebook.app_secret');?>
					:
				</h4>
