...
<div class="bg">
	...
	<div style="width: 100%; background: #DDD; padding: 10px;">
		<h4>
		<?php print Kohana::lang('feedback.feedback'); ?>
		</h4>
	...
	<div class="green-box">
		<h3>
		<?php print Kohana::lang('feedback.feedback_confirm_mesg');?>
		</h3>
	</div>
	<br /> <br />
	<?php
	...
	<div style="width: 100%; padding: 10px;">
		...
		<h3>
		<?php print Kohana::lang('feedback.feedback_send_reply')?>
		</h3>
		</br /> <br />
		<div class="row">
			<br /></br />
		...
		<div class="row">
			...
			<input type="hidden" name="person_email" id="person_email"
				value="<?php print $feedback->person_email?>" />
