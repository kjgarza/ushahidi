...
<div
	...
	<div class="tabs">
		...
		<div class="tab">
			<ul>
				<li><a href="#" onClick="checkinsAction('d', 'DELETE', '')"><?php echo strtoupper(Kohana::lang('ui_main.delete'));?>
				</a></li>
			</ul>
		</div>
	</div>
			...
			foreach ($checkins as $checkin)
			{
				...
				<tr>
					...
					<td class="col-2">
						...
						<ul class="info">
						<?php
						if(strstr($checkin_from,'@')) {
							echo '<a href="mailto:'.$checkin_from.'">'.$checkin_from.'</a>';
						}else{
							echo '<small><em>Unknown Email Address</em> '.$checkin_from.'</small>';
						}
						?>
						</ul>
					</td>
					...
					<td class="col-4">
						<ul>
							<!-- TODO: Add Create Report Functionality
												...
												-->
							<li><a
								href="javascript:checkinsAction('d','DELETE','<?php echo(rawurlencode($checkin_id)); ?>')"
