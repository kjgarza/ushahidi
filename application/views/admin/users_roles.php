...
<div
	...
	<div class="red-box">
		<h3>
		<?php echo Kohana::lang('ui_admin.error_msg');?>
		</h3>
		<ul>
		<?php
	...
	<div class="tabs">
		...
		<!-- tabset -->
		<ul class="tabset">
			<li><a href="#" class="active" onclick="show_addedit(true)"> <?php echo Kohana::lang('ui_admin.header_add_edit'); ?>
			</a>
			</li>
		</ul>
		<!-- tab -->
		...
		<?php print form::open(NULL,array('id' => 'rolesMain',
			...
			<input type="hidden" name="action" id="action" value="a" /> <input
				type="hidden" id="role_id" name="role_id" value="">
			...
			<div class="tab_form_item">
				<strong> <a href="#" class="tooltip"
					style="background-position-y: 0px"
					title="<?php echo Kohana::lang("tooltips.settings_access_level"); ?>">
					<?php echo  Kohana::lang('ui_admin.access_level'); ?>: </a>
					</h4> <?php print form::input('access_level','', ' class="text"'); ?>
	...
	<?php print form::open(NULL,array('id' => 'roleListing',
				 	'name' => 'roleListing')); ?>
		<input type="hidden" name="action" id="role_action_main" value=""> <input
			type="hidden" name="role_id" id="role_id_main" value="">
		<div class="table-holder">
			<table class="table">
				<thead>
					<tr>
						<th class="col-1">&nbsp;</th>
						<th class="col-2"><?php echo Kohana::lang('ui_admin.header_role'); ?>
						</th>
						<th class="col-2">&nbsp;</th>
						<th class="col-4"><?php echo Kohana::lang('ui_admin.header_actions')?>
						</th>
					</tr>
				</thead>
				<tfoot>
				...
				foreach ($roles as $role)
				{
					...
					<tr>
						...
						<td class="col-3">&nbsp;</td>
						<td class="col-4"><?php if($role_id == 1 OR $role_id == 3 OR $role->name == "member") { echo "&nbsp;";
							...
							<ul>
								<li class="none-separator"><a href="#"
									onClick="fillFields(
													...
													)"> <?php echo Kohana::lang('ui_admin.edit_action');?> </a>
								</li>
								<li><a
									href="javascript:rolesAction('d','DELETE','<?php echo(rawurlencode($role_id)); ?>')"
									class="del"> <?php echo Kohana::lang('ui_admin.delete_action');?>
								</a></li>
							</ul> <?php } ?>
						</td>
					</tr>
