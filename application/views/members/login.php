...
<body>
	<div id="openid_login_container">
		...
		if ($success)
		{
			...
			<?php echo "&#8226;&nbsp;" . Kohana::lang('ui_main.login_confirmation_sent');?>
			</div>
			<?php
		}
		?>
			<h2>
				<a href="javascript:toggle('signin_userpass');"><?php echo Kohana::lang('ui_main.login_signin_userpass'); ?>
				</a>
			</h2>
						...
						<table width="100%" border="0" cellspacing="3" cellpadding="4"
							...
							<tr>
								<td><input type="checkbox" id="remember" name="remember"
									value="1" checked="checked" /> <?php echo Kohana::lang('ui_main.password_save');?>
								</td>
							</tr>
							<tr>
								<td><input type="submit" id="submit" name="submit"
									value="Log In" class="login_btn" /></td>
							</tr>
							<tr>
								<td><a href="javascript:toggle('signin_forgot');"> <?php echo Kohana::lang('ui_main.forgot_password');?>
								</a></td>
							</tr>
						</table>
				...
				<form method="post" id="userforgot_form">
					<input type="hidden" name="action" value="forgot">
						<table width="100%" border="0" cellspacing="3" cellpadding="4"
							background="" id="ushahidi_loginbox">
							<tr>
								<td><strong><?php echo Kohana::lang('ui_main.password_reset_prompt');?>
								</strong><br /> <?php print form::input('resetemail', $form['resetemail'], ' class="login_text"'); ?>
								</td>
							</tr>
							<tr>
								<td><input type="submit" id="submit" name="submit"
									value="Reset password" class="login_btn" /></td>
							</tr>
						</table>
			...
			<h2>
				<a href="javascript:toggle('signin_openid');"><?php echo Kohana::lang('ui_main.login_signin_openid'); ?>
				</a>
			</h2>
				...
				<form method="post" id="openid_form">
					<input type="hidden" name="action" value="openid">
						<div id="openid_choice">
							<p>
							<?php echo Kohana::lang('ui_main.login_select_openid'); ?>
								:
							</p>
			...
			, <a href="javascript:toggle('signin_new');"><?php echo Kohana::lang('ui_main.login_signup_click'); ?>
			</a>
					...
					<input type="hidden" name="action" value="new">
						<table width="100%" border="0" cellspacing="3" cellpadding="4"
							...
							<tr>
								...
								<?php print form::input('name', $form['name'], ' class="login_text"'); ?>
								</td>
							</tr>
							<tr>
								<td><strong><?php echo Kohana::lang('ui_main.email');?>:</strong><br />
								<?php print form::input('email', $form['email'], ' class="login_text"'); ?>
								</td>
							</tr>
							<tr>
								<td><strong><?php echo Kohana::lang('ui_main.username');?>:</strong><br />
								<?php print form::input('username', $form['username'], ' class="login_text"'); ?>
								</td>
							</tr>
							<tr>
								<td><strong><?php echo Kohana::lang('ui_main.password');?>:</strong><br />
								<?php print form::password('password', $form['password'], ' class="login_text"'); ?>
								</td>
							</tr>
							<tr>
								<td><strong><?php echo Kohana::lang('ui_main.password_again');?>:</strong><br />
									<?php print form::password('password_again', $form['password_again'], ' class="login_text"'); ?>
								</td>
							</tr>
							<tr>
								<td><input type="submit" id="submit" name="submit"
									value="Sign Up" class="login_btn" /></td>
							</tr>
						</table>
