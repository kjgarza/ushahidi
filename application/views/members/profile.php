	...
	?>
		...
		<div class="sms_holder">
			...
			<div class="row">
				<h4>
					<a href="#" class="tooltip"
						title="<?php echo Kohana::lang("tooltips.profile_public"); ?>"><?php echo Kohana::lang('ui_main.public_profile');?>:</a>
				</h4>
				<?php
			...
			<div class="row">
				<h4>
					<a href="http://www.gravatar.com/" target="_blank" class="tooltip"
						title="<?php echo Kohana::lang("tooltips.change_picture"); ?>"><?php echo Kohana::lang('ui_main.change_picture');?>
					</a>
				</h4>
				<a href="http://www.gravatar.com/" target="_blank"><img
					src="<?php echo members::gravatar($form['email']); ?>" width="80"
					border="0" /> </a>
			</div>
			<div class="row">
				<h4>
					<a href="http://www.gravatar.com/" target="_blank" class="tooltip"
						title="<?php echo Kohana::lang("tooltips.profile_color"); ?>"><?php echo Kohana::lang('ui_main.profile_color');?>
					</a>
				</h4>
