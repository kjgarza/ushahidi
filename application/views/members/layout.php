		...
		<div id="header">
				...
				<ul>
					...
					<li class="none-separator"><a href="<?php echo url::site() ?>"
						...
						<li class="none-separator"><a
							href="<?php echo url::site()."members/profile/" ?>"><?php echo Kohana::lang('ui_admin.my_profile');?>
						</a></li>
						<li><a href="<?php echo url::site()."members/";?>log_out"><?php echo Kohana::lang('ui_admin.logout');?>
						</a></li>
			...
			<div class="info-nav">
				...
				<div class="info-search">
					<form action="<?php echo url::site() ?>members/reports"
						id="info-search">
			...
			<div class="nav-holder">
				...
				<?php foreach($main_tabs as $page => $tab_name){ ?>
					<li><a
						href="<?php echo url::site(); ?>members/<?php echo $page; ?>"
