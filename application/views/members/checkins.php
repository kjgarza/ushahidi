...
<div
	...
	<div class="tabs">
		...
		<div class="tab">
			<ul>
				<li><a href="#" onClick="checkinAction('d', 'DELETE', '')"><?php echo strtoupper(Kohana::lang('ui_main.delete'));?>
				</a></li>
			</ul>
		</div>
	</div>
	...
	<input type="hidden" name="action" id="action" value=""> <input
		...
		name="checkin_id[]" id="checkin_single" value="">
	<div class="table-holder">
		<table class="table">
			<thead>
				<tr>
					<th class="col-1"><input id="checkall" type="checkbox"
						class="check-box" onclick="CheckAll( this.id, 'checkin_id[]' )" />
					</th>
					<th class="col-2"><?php echo Kohana::lang('ui_admin.checkin_details');?>
					</th>
			...
			foreach ($checkins as $checkin)
			{
				...
				?>
				<tr>
					<td class="col-1"><input name="checkin_id[]" id="checkin"
						value="<?php echo $checkin_id; ?>" type="checkbox"
						class="check-box" /></td>
					<td class="col-2">
						<div class="post">
							<p>
							...
							<p>
								<a
									href="javascript:showCheckin('checkin_preview_<?php echo $checkin_id?>', '<?php echo $longitude?>', '<?php echo $latitude?>')"><?php echo Kohana::lang('ui_admin.preview');?>
								</a>
							</p>
							<div id="checkin_preview_<?php echo $checkin_id?>"
								class="preview_div">
								<?php echo $description; ?>
								<div id="checkin_preview_<?php echo $checkin_id?>_map"
						...
						<ul class="info">
							<li class="none-separator"><?php echo Kohana::lang('ui_main.location');?>:
								<strong><?php echo $latitude.", ".$longitude; ?> </strong></li>
							<li><?php echo Kohana::lang('ui_main.auto_checkin');?>: <strong><?php echo $auto_checkin; ?>
							</strong></li>
						</ul>
					</td>
					...
					<td class="col-4">
						...
						?>
							<li class="none-separator"><a
								href="javascript:checkinAction('d','DELETE','<?php echo(rawurlencode($checkin_id)); ?>')"
