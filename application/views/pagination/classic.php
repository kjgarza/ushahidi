...
<ul class="pager">
	...
	<li class="first"><?php echo $total_pages . " " . Kohana::lang('ui_main.pages') ?>
	</li>
	...
	<?php else: ?>
	<li><a href="<?php echo str_replace('{page}', $i, $url) ?>"><?php echo $i ?>
	</a></li>
	<?php endif ?>
	...
	<li><a href="<?php echo str_replace('{page}', $total_pages, $url) ?>"><?php echo $total_pages ?>
	</a></li>
	<?php endif ?>
