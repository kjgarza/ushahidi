		...
		<div id="ushahidi_login">
			...
			<form method="POST" name="frm_install" action="process.php"
				...
				<div class="feedback info">
					<p>
						For more information, please check out <a
							href="http://wiki.ushahidi.com/doku.php?id=a_brief_word_on_databases"
							target="_blank">this article</a> on the wiki that talks about
				...
				<table class="form-table fields">
					<tbody>
						...
						<tr>
							...
							<td><input type="text"
								value="<?php print $form->value('db_name'); ?>" size="25"
								id="db_name" name="db_name" /></td>
							<td>The name of the database you want to run Ushahidi in.</td>
						</tr>
						<tr>
							<th scope="row"><label for="username">User Name</label></th>
							<td><input type="text"
								value="<?php print $form->value('username'); ?>" size="25"
						...
						<tr>
							...
							<td><input type="password"
								value="<?php print $form->value('password'); ?>" size="25"
				...
				<table class="form-table">
					<tbody>
						<tr>
							...
							<td class="prev"><input type="submit" id="install"
								name="basic_db_info" value="Continue &rarr;" class="button" /></td>
						</tr>
					</tbody>
				</table>
			</form>
