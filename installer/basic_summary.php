			...
			<form method="POST" name="frm_install" action="process.php"
				...
				<div class="feedback info">
					...
					<ul>
						<li><a
							...
							target="_blank">Unix/Linux</a></li>
						<li><a href="http://support.microsoft.com/kb/308419"
							target="_blank">Windows</a></li>
					</ul>
				</div>


				<p>For the installation process, please have the following bits of
					information on hand.</p>
				...
				<p>
					<a class="button" href="index.php">&larr; Go back</a>&nbsp;&nbsp; <input
						type="submit" id="basic_perm_pre_check"
						name="basic_perm_pre_check" value="Let's get started!"
						class="button" />
				</p>
