...
<table class="calendar">
	<tr class="controls">
		...
		<td class="title" colspan="5"><?php echo strftime('%B %Y', mktime(0, 0, 0, $month, 1, $year)) ?>
		</td>
	...
	?>
		<td class="<?php echo implode(' ', $classes) ?>"><span class="day"><?php echo $day[0] ?>
		</span> <?php echo $output ?></td>
		<?php endforeach ?>
	</tr>
	<?php endforeach ?>
</table>
